...
export class InitMigration1742466475343 implements MigrationInterface {
    name = 'InitMigration1742466475343'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "strategy_sale" ADD CONSTRAINT "FK_3f542f07b37b69725b4f2cfbd6d" FOREIGN KEY ("categoryId") REFERENCES "category"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "strategy_sale" DROP CONSTRAINT "FK_3f542f07b37b69725b4f2cfbd6d"`);
